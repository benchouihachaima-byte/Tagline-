...
DATA = {
    "ثانية ثانوي": {
        "رياضيات": ["العلوم الفيزيائية", "علوم الطبيعة والحياة", "الرياضيات"],
        "علوم تجريبية": ["العلوم الفيزيائية", "علوم الطبيعة والحياة", "الرياضيات"]
    },
    "ثالثة ثانوي": {
        "رياضيات": ["الفلسفة", "العلوم الفيزيائية", "علوم الطبيعة والحياة", "الرياضيات"],
        "علوم تجريبية": ["الفلسفة", "العلوم الفيزيائية", "علوم الطبيعة والحياة", "الرياضيات"]
    }
}
}
